...
const ApplicationDescription = () => {
  return (
    <div className="description-container" data-testid="description-container">
      ...
      <p>James is a tool for research in the Digital Humanities that combines LDA topic modelling and sentiment analysis to analyze attitudes towards topics present in text. 
      ...
      <p>Please note: James was designed and trained using English text; while James will allow you to upload documents containing text in other languages, the results will certainly be unintended.</p>
      ...
      <p>Once James has finished processing your input, you will see the results displayed on the screen. You also have the option to download your results as a .csv file using the 'Download Results' button at the very top of the page.<br /><br />
        At the top of the results, you'll see the list of topics generated by the topic model for your input text. Each of these topics will be numbered for identification. Immediately below the topic number, you'll find a button that allows you to hide or show each topic from the results. [TODO] Something about coherence score<br />
      ...
      <h4>How It Works</h4>
      <p>
        James uses <a href="https://en.wikipedia.org/wiki/Latent_Dirichlet_allocation">Latent Dirichlet Allocation</a> for topic modelling.<br />Specifically, the <a href="http://mallet.cs.umass.edu/">MALLET</a> implementation of LDA.<br /><br />
